...
static struct pinmux_config rmii2_pin_mux[] = {
	...
	{"gpmc_wpn.rmii2_rxer", OMAP_MUX_MODE3 | AM33XX_PIN_INPUT_PULLDOWN},
...
static struct pinmux_config uart4_pin_mux[] = {
	{"uart0_ctsn.uart4_rxd", OMAP_MUX_MODE1 | AM33XX_SLEWCTRL_SLOW |
						AM33XX_PIN_INPUT_PULLUP},
	{"uart0_rtsn.uart4_txd", OMAP_MUX_MODE1 | AM33XX_PULL_UP |
						AM33XX_PULL_DISA |
						AM33XX_SLEWCTRL_SLOW},
	{NULL, 0},
};
...
static struct pwmss_platform_data  pwm_pdata[4] = {
	{
...
static struct pinmux_config gpio_keys_officelink_pin_mux[] = {
	{"gpmc_ad12.gpio1_12", OMAP_MUX_MODE7 | AM33XX_PIN_INPUT_PULLUP},
	{NULL, 0},
};

static struct pinmux_config gpio_led_officelink_pin_mux[] = {
...
static void gpio_officelink_init(int evm_id, int profile)
{
	setup_pin_mux(gpio_led_officelink_pin_mux);
	setup_pin_mux(gpio_keys_officelink_pin_mux);
	am33xx_register_ehrpwm(2, &pwm_pdata[2]);
...
static struct evm_dev_cfg azm335x_dev_cfg[] = {
	...
	//{mfd_tscadc_init,	DEV_ON_BASEBOARD, PROFILE_ALL},
    {gpio_officelink_init, DEV_ON_BASEBOARD, PROFILE_ALL},
	{NULL, 0, 0},
};
