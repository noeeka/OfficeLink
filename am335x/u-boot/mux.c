...
static struct module_pin_mux rmii2_pin_mux[] = {
	{OFFSET(gpmc_csn3), MODE(2) | RXACTIVE},     /* RMII2_CRS */
	{OFFSET(mii1_col), MODE(1) | RXACTIVE},      /* RMII1_REFCLK */
	{OFFSET(gpmc_a11), MODE(3) | RXACTIVE},      /* RMII1_RXD0 */
	{OFFSET(gpmc_a10), MODE(3) | RXACTIVE},      /* RMII1_RXD1 */
	{OFFSET(gpmc_wpn), MODE(3) | RXACTIVE},      /* RMII1_RXERR */
	{OFFSET(gpmc_a5), MODE(3)},                  /* RMII1_TXD0 */
	{OFFSET(gpmc_a4), MODE(3)},                  /* RMII1_TXD1 */
...
static struct evm_pin_mux azm335x_pin_mux[] = {
	{uart0_pin_mux, PROFILE_ALL, DEV_ON_BASEBOARD},
	{i2c1_pin_mux, PROFILE_ALL, DEV_ON_BASEBOARD},
#ifdef CONFIG_NAND
	...
	{rmii1_pin_mux, PROFILE_ALL, DEV_ON_BASEBOARD},
	{rmii2_pin_mux, PROFILE_ALL, DEV_ON_BASEBOARD},
#endif
#ifdef CONFIG_MMC
	{mmc0_pin_mux, PROFILE_ALL, DEV_ON_BASEBOARD},
#endif
