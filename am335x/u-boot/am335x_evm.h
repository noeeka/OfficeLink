...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"net_boot=echo Booting from network ...; " \
		...
		"run net_args; " \
		"bootm ${kloadaddr}\0" \
    "restore=nand scrub.chip;mmc rescan;fatload mmc 0 0x80100000 MLON;nand write 0x80100000 0 0x10000;fatload mmc 0 0x80100000 u-bootn.img;nand write 0x80100000 0x80000 0x40000\0" \

#ifdef CONFIG_SYS_BOOT_SDCARD
...
#define DDR2_MT47H64M8CF_25E
#ifdef DDR2_MT47H64M8CF_25E
#define PHYS_DRAM_1_SIZE		0x8000000	/* 128 MiB */
#else
...
#else
    #error Please Define CONFIG_CMD_NET!!!
#endif
...
#define MNAND_ENV_OFFSET		0x20000 /* environment starts here */
